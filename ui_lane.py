...
#
# Created: Tue May 26 15:37:34 2015
...
class Ui_Lane(object):
    def setupUi(self, Lane):
        ...
        self.splitter = QtGui.QSplitter(self.attributeGroup)
        self.splitter.setGeometry(QtCore.QRect(10, 80, 461, 25))
        self.splitter.setOrientation(QtCore.Qt.Horizontal)
        self.splitter.setObjectName(_fromUtf8("splitter"))
        self.pedestrian = QtGui.QCheckBox(self.splitter)
        self.pedestrian.setObjectName(_fromUtf8("pedestrian"))
        self.bicycle = QtGui.QCheckBox(self.splitter)
        self.bicycle.setObjectName(_fromUtf8("bicycle"))
        self.truck = QtGui.QCheckBox(self.splitter)
        self.truck.setObjectName(_fromUtf8("truck"))
        self.bus = QtGui.QCheckBox(self.splitter)
        self.bus.setObjectName(_fromUtf8("bus"))
        self.van = QtGui.QCheckBox(self.splitter)
        self.van.setObjectName(_fromUtf8("van"))
        self.taxi = QtGui.QCheckBox(self.splitter)
        self.taxi.setObjectName(_fromUtf8("taxi"))
        self.widget = QtGui.QWidget(self.attributeGroup)
        self.widget.setGeometry(QtCore.QRect(11, 192, 451, 27))
        self.widget.setObjectName(_fromUtf8("widget"))
        self.horizontalLayout = QtGui.QHBoxLayout(self.widget)
        self.horizontalLayout.setMargin(0)
        self.horizontalLayout.setObjectName(_fromUtf8("horizontalLayout"))
        self.can_stop = QtGui.QCheckBox(self.widget)
        self.can_stop.setObjectName(_fromUtf8("can_stop"))
        self.horizontalLayout.addWidget(self.can_stop)
        self.high_occ_veh = QtGui.QCheckBox(self.widget)
        ...
        self.widget1.setGeometry(QtCore.QRect(13, 221, 451, 27))
        self.widget1.setObjectName(_fromUtf8("widget1"))
        self.horizontalLayout_2 = QtGui.QHBoxLayout(self.widget1)
        self.horizontalLayout_2.setMargin(0)
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.can_park = QtGui.QCheckBox(self.widget1)
    ...
    def retranslateUi(self, Lane):
        ...
        self.checkBox_10.setText(_translate("Lane", "Has Road Shoulder", None))
